    ...
    >
      <div className="showcase-product-image">
        ...
        <div className="showcase-sizes-wrapper">
          <ul>
            ...
            <li onClick={() => setSelectedSize("M")}>M</li>
            <li onClick={() => setSelectedSize("L")}>L</li>
            <li onClick={() => setSelectedSize("XL")}>XL</li>
            <li onClick={() => setSelectedSize("XXL")}>XXL</li>
          </ul>
        </div>
      </div>
      <div className="showcase-product-info">
        ...
        <div className="showcase-product-options">
          <div className="showcase-product-options-left">
            <div className="opt-el">
              <span
                className="minus-btn"
                onClick={() => {
                  if (productPiece > 1) setProductPiece(productPiece - 1);
                }}
              >
                <MinusIcon />
              </span>
          ...
          <div
            className="showcase-product-options-right"
            onClick={() => {
              if (selectingSize) {
        ...
        <div
          className="showcase-product-add-cart-btn"
          onClick={() => {
            if (selectedSize === "") {
